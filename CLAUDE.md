...
**YOU ARE IN: `fin/polecats/opal/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/fin/` (rig root) or other directories
...
**Your mail address:** `fin/polecats/opal`
**Your rig:** fin
**Your Witness:** `fin/witness`
...
| Ask Witness for help | `gt mail send fin/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`fin/witness`) when:
...
```bash
gt mail send fin/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
